...
const ALLOWED_ORIGINS = new Set<string>([
  ...
  "http://localhost:9009",
  "http://localhost:9010",
  // En producción cada servicio tiene su propio subdominio todos los
  // subdominios del mismo owner en Render comparten origen padre;
  // se agregan aquí los paneles front.
  "https://s1-panel.onrender.com",
  "https://s2-carlos-code.onrender.com",
]);
...
/** Aplica cabeceras CORS a una respuesta (solo si el origen está en allowlist). */
...
/** True si el request es un preflight OPTIONS y debe responderse sin procesar. */
...
/** Envuelve un Response con cabeceras CORS (para rutas que no lo hacen). */
